...
function SubscribeOrgButton( {user,orgName,orgId,subscribedorgs,org}) {
  ...
  const [SubscribeFunction] = useMutation(SUBSCRIBE_TO_ORG, {
    variables: { orgId: orgId },
        ...
        // console.log(result,proxy,"to result kai to proxy")
        // const data = proxy.readQuery({
        //   query: FETCH_SUBSCRIBEDORGS_QUERY,
        ...
        //   variables:{username:user.username},
        //   data: {
        //     getSubscribedOrgs: [result.data.subscribeOrg.subscribed.org.orgName,
        //       result.data.subscribeOrg.subscribed.org.orgDescription, result.data.subscribeOrg.subscribed.org.orgLocationLat,
        //       result.data.subscribeOrg.subscribed.org.orgLocationLong, result.data.subscribeOrg.subscribed.org.orgType,
        //       result.data.subscribeOrg.subscribed.org.orgOwner, result.data.subscribeOrg.subscribed.org.profilePic,  ...data.getSubscribedOrgs]
        //     }
        // });
