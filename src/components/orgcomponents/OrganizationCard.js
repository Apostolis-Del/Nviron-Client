...
function OrganizationCard({org,username}){

    const {orgName,orgDescription,orgOwner,id,profilePic} = org
    ...
    return(
        ...
        <Card fluid>
            ...
            <Card.Content extra>
                ...
                {user&&
                <SubscribeOrgButton user={user} orgName={orgName} org={org} orgId={id} 
